...
export = HttpError;
/**
     * boom provides a set of utilities for returning HTTP errors. Each utility returns a HttpError error response object (instance of Error) which includes the following properties:
     * @see {@link https://github.com/hapijs/boom#boom}
     */
declare class HttpError<Data = any> extends Error {

        /** Creates a new HttpError object using the provided message and then calling boomify() to decorate the error with the HttpError properties. */
        constructor(message?: string | Error, options?: HttpError.Options<Data>);
        /** isHttpError - if true, indicates this is a HttpError object instance. */
        isHttpError: boolean;
...
declare namespace HttpError {
    ...
    interface Options<Data> {
        ...
        message?: string;
        /** override - if false, the err provided is a HttpError object, and a statusCode or message are provided, the values are ignored. Defaults to true (apply the provided statusCode and message options to the error regardless of its type, Error or HttpError object). */
        override?: boolean;
        /** code - the error code */
        code?: string | number;
        /** level -  define the level of the error */
        level?: Level;
        /** type - error type */
        type?: Type;
    }
     ...
     */
     function boomify(error: Error, options?: { statusCode?: number, message?: string, override?: boolean, code?: string | number }): HttpError<null>;
     ...
     */
     function badRequest<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function unauthorized(message?: string, scheme?: string, attributes?: {[index: string]: string}, code?: string | number): HttpError<null>;
     ...
     */
     function paymentRequired<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function forbidden<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function notFound<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function methodNotAllowed<Data = null>(message?: string, data?: Data, allow?: string | string[], code?: string | number): HttpError<Data>;
     ...
     */
     function notAcceptable<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function proxyAuthRequired<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function clientTimeout<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function conflict<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function resourceGone<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function lengthRequired<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function preconditionFailed<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function entityTooLarge<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function uriTooLong<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function unsupportedMediaType<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function rangeNotSatisfiable<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function expectationFailed<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function teapot<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function badData<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function locked<Data = null>(message?: string, data?: Data, code?: string | number ): HttpError<Data>;
     ...
     */
     function failedDependency<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function preconditionRequired<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function tooManyRequests<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function illegal<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function badImplementation<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     * @see {@link https://github.com/hapijs/boom#boombadimplementationmessage-data---alias-internal}
     */
     function internal<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function notImplemented<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function badGateway<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function serverUnavailable<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
     ...
     */
     function gatewayTimeout<Data = null>(message?: string, data?: Data, code?: string | number): HttpError<Data>;
}